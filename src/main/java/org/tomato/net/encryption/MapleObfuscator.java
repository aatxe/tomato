package org.tomato.net.encryption;
...
/**
 * A generic packet obfuscator for all packets.
 * @author tomato
 * @version 1.0
 * @since alpha
 */
public class MapleObfuscator {
	...
	/**
	 * Creates a new packet obfuscator.
	 * @param key the key to be used for the obfuscator
	 * @param iv the initialization vector for the encryption
	 * @param mapleVersion the desired MapleStory version
	 */
	public MapleObfuscator(byte key[], byte iv[], short mapleVersion) {
	...
	/**
	 * Sets a new initialization vector for this object.
	...
	/**
	 * Multiplies a range of bytes in an array by a number.
	 * @param in the array to get the bytes from
	 * @param count the index to stop multiplying at
	 * @param mul the number to multiply by
	 * @return the multiplied array of bytes
	 */
	...
	/**
	 * Performs an action of encryption or decryption.
	 * @param data the data to be worked on
	 * @return the now encrypted/decrypted data
	 */
	...
	/**
	 * Forces an update of the initialization vector.
	 */
	...
	/**
	 * Gets a packet header based on packet length.
	 * @param length the length to be used
	 * @return the generated packet header
	 */
	...
	/**
	 * Gets a packet's length based on the packet header.
	 * @param packetHeader the header to be used
	 * @return the determined packet length
	 */
	...
	/**
	 * Checks the validity of a packet header.
	 * @param packetHeader the packet header to be checked
	 * @return whether or not the packet header is valid
	 */
	...
	/**
	 * Calculates a new initialization vector based on an old one.
	 * @param oldIv the old initialization vector
	...
	/**
	 * Returns the initialization vector as a human-readable string.
	 */
	@Override
	...
	/**
	 * Fixes some oddities in calculating new initialization vectors
	 * @param inputByte the byte from the old initialization vector that needs work
	 * @param in the initialization vector to fix
	 * @return the fixed initialization vector
	 */
